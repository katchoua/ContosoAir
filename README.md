[![Build Status](https://dev.azure.com/gkatchoua/contosoair/_apis/build/status%2Fkatchoua.ContosoAir?branchName=master&jobName=Job)](https://dev.azure.com/gkatchoua/contosoair/_build/latest?definitionId=5&branchName=master)
